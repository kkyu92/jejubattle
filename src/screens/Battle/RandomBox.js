...
export default function RandomBox(props) {
  return (
    <Container>
      <Header left={'back'} title={'랜덤박스 확률정보'} navigation={props.navigation} />
      <KeyboardAwareScrollView>
        ...
        <View style={{padding: 20}}>
          ...
          <HView style={{backgroundColor: 'whitesmoke'}}>
            <View style={{flex: 0.7, paddingVertical: 10, borderWidth: 1, borderColor: 'lightgray', alignItems: 'center', justifyContent: 'center'}}>
              <Text text={'상품'} fontSize={16} fontWeight={'bold'} />
            </View>
            <View style={{flex: 0.3, marginLeft: -1, paddingVertical: 10, borderWidth: 1, borderColor: 'lightgray', alignItems: 'center', justifyContent: 'center'}}>
