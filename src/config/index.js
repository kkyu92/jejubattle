export const API_URL = 'https://jejubattle.com/api/';
// export const API_URL = 'https://kangmin.shop/api/';
// export const SOCKET_URL = 'https://kangmin.shop/stompWebSocket';
export const SOCKET_URL = 'https://jejubattle.com/stompWebSocket';
...
export const IOS_STORE_ID = '1527355595';
