          ...
          {props.mask ? (
            <MaskedInput
              ...
              style={{
                ...
                borderWidth:
                  props.borderWidth !== undefined ? props.borderWidth : 1,
        ...
        <InputAccessoryView nativeID={inputAccessoryViewID}>
          <View
            style={{
              alignItems: 'flex-end',
              backgroundColor:
                props.keyboardCloseBackgroundColor || Nuno.config.themeColor,
              borderTopWidth: 1,
            ...
            <TouchableOpacity
              ...
              <AntDesign
                name={'close'}
                size={20}
                color={props.keyboardCloseColor || 'white'}
              />
            </TouchableOpacity>
          </View>
        </InputAccessoryView>
